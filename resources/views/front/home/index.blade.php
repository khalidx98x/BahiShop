...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="{{asset('front/images/discount-product/product-1.jpg')}}" alt="Product">
                        </div> <!-- product image -->
                ...
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="{{asset('front/images/discount-product/product-2.jpg')}}" alt="Product">
                        </div> <!-- product image -->
                        <div class="product-content">
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="{{ asset('uploads/product') }}/{{ $product->image }}" alt="Product"></a>
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                ...
                                                <span class="regular-price">{{$product->peice}}</span>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-left mt-45">
                        <div class="services">
                            <img src="{{asset('front/images/services/services.jpg')}}" alt="">
                ...
                <div class="col-lg-12">
                    <div class="showcase-active mt-65">
                        <div class="single-showcase">
                            <img src="{{asset('front/images/showcase/t-1.jpg')}}" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                        <div class="single-showcase">
                            <img src="{{asset('front/images/showcase/t-2.jpg')}}" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                    </div> <!-- showcase active -->
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="{{asset('front/images/team/t-1.jpg')}}"
                             alt="Team">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="{{asset('front/images/team/t-2.jpg')}}"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="{{asset('front/images/team/t-3.jpg')}}"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="{{asset('front/images/team/t-4.jpg')}}"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
    ...
    <section id="testimonial" class="testimonial-area pt-200">
        <div class="testimonial-bg bg_cover" style="background-image: url({{asset('front/images/testimonial/ts-bg.jpg')}})"></div>
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="{{asset('front/images/blog/b-1.jpg')}}" alt="Blog">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="meta d-flex justify-content-between align-items-center">
                                <div class="meta-admin d-flex align-items-center">
                                    <div class="image">
                                        <a href="#"><img src="{{asset('front/images/blog/admin.jpg')}}" alt="Admin"></a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="{{asset('front/images/blog/b-2.jpg')}}" alt="Blog">
                        </div>
                        <div class="blog-content">
                            <div class="content">
                                <h4 class="title"><a href="#">Rowan an orangutan known  & loved</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="{{asset('front/images/blog/b-3.jpg')}}" alt="Blog">
                        </div>
                        <div class="blog-content">
                            <div class="content">
                                <h4 class="title"><a href="#">Rowan an orangutan known  & loved</a></h4>
